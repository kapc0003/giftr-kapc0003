...
window.addEventListener('push', function (ev){
    ...
    switch (id) {
        case "index": 
            ...
            cancelButton.addEventListener("click", ModalCancel);
            DisplayListPeople();
            break;
        case "gifts":  
            let SaveGiftButton = document.getElementById("SaveGiftButton");
            SaveGiftButton.addEventListener("click", SaveGift);
            let CancelGiftBtn = document.getElementById("CancelGiftBtn");
            CancelGiftBtn.addEventListener("click", CancelGiftModal);
            DeterminePerson();
            break;
        default:
            DisplayListPeople();
...
function DisplayListPeople(){
    ...
    for(let i = 0; i < length; i++){
        ...
        aName.addEventListener("touchstart",EditBtn);
        aDob.addEventListener("touchstart", SwitchPage);
    }
